...
from crazyswarm.msg import TrajectoryPolynomialPiece, FullState, Position, VelocityWorld, MotorControl
...
class Crazyflie:
    ...
    def __init__(self, id, initialPosition, tf):
        ...
        # added by Beren
        self.cmdPwmPublisher = rospy.Publisher(prefix + "/cmd_pwm", MotorControl, queue_size=1)
        self.cmdPwmMsg = MotorControl()
        # self.cmdPwmMsg.header.seq = 0
        # self.cmdPwmMsg.header.frame_id = "/world"
        # added by Beren
    ...
    #added by Beren
    def cmdPwm(self, pwm1, pwm2, pwm3, pwm4):
        # self.cmdPwmMsg.header.stamp = rospy.Time.now()
        # self.cmdPwmMsg.header.seq += 1
        self.cmdPwmMsg.pwm1 = pwm1
        self.cmdPwmMsg.pwm2 = pwm2
        self.cmdPwmMsg.pwm3 = pwm3
        self.cmdPwmMsg.pwm4 = pwm4
        self.cmdPwmPublisher.publish(self.cmdPwmMsg)
